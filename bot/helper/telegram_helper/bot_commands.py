...
class _BotCommands:
    def __init__(self):
        ...
        self.YtdlCommand = (f'watch{CMD_INDEX}', f'w{CMD_INDEX}')
        self.YtdlZipCommand = (f'zipwatch{CMD_INDEX}', f'zw{CMD_INDEX}')
        ...
        self.YtdlLeechCommand = (f'leechwatch{CMD_INDEX}', f'lw{CMD_INDEX}')
        self.YtdlZipLeechCommand = (f'zipleechwatch{CMD_INDEX}', f'zlw{CMD_INDEX}')
